...
function InPlaceEstablishmentSelector_btnFind_Click(id, mode) {
    ...
    var url = "ModalDialogWrapper.axd?" + SITE_VIRTUAL_ROOT + "AbacusExtranet/Apps/InPlaceSelectors/Establishments.aspx?ref=" +
...
function InPlaceEstablishmentSelector_IsEnabled(id) {
    return !GetElement(id + "_txtName").disabled;
}