...
Namespace Apps.Res.Occupancy

    ''' <summary>
    ''' Wizard screen to search for and view residential occupancy.
    ''' </summary>
    ''' <remarks></remarks>
    ''' <history>
    ''' JohnF    18/11/2013  Initial version (D12526K)
    ''' </history>
...
#Region "Fields"
        ...
        Private Const _WebNavMenuItemKey As String = "AbacusExtranet.WebNavMenuItem.OccupancyEnquiry"
...
#Region " Events "
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            '++ Setup the page..
            Me.InitPage(ConstantsManager.GetConstant(_WebNavMenuItemKey), "Residential Occupancy Enquiry")

            Dim resultSettings As New ResidentialOccupancySettings()
