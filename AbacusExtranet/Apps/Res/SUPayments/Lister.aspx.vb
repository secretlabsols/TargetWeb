...
Namespace Apps.Res.SUPayments

    ''' <summary>
    ''' Wizard screen to search for and view service user payments.
    ''' </summary>
    ''' <remarks></remarks>
    ''' <history>
    ''' JohnF    21/11/2013  Initial version (D12526M)
    ''' </history>
...
#Region "Fields"
        ...
        Private Const _WebNavMenuItemKey As String = "AbacusExtranet.WebNavMenuItem.ServiceUserPaymentEnquiry"
...
#Region " Events "
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            '++ Setup the page..
            Me.InitPage(ConstantsManager.GetConstant(_WebNavMenuItemKey), "Residential Service User Payment Enquiry")

            Dim resultSettings As New ServiceUserPaymentSettings()
