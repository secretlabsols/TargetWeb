<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="NonResidentialServiceUserPaymentHeader.ascx.vb" Inherits="Target.Abacus.Extranet.Apps.UserControls.NonResidentialServiceUserPaymentHeader" %>
