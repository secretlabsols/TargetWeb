<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Lister.aspx.vb" Inherits="Target.Abacus.Extranet.Apps.ServiceOrders.NonRes.ServiceOrders.Lister" %>
...
<div id="dso_dialog" style="display: none;">
	...
	<div id="tabs">
		...
		<div id="tab-Order" style="height: 150px;">
		</div>
		<div id="tab-Details">
	...
	<script id="OrderDetailTemplate" type="text/html">
		<table id="tblDSODetail" class="listTable " cellspacing="0" cellpadding="2" summary="Service Order Details" width="99%">
				<thead>
					<tr>
					   <th style="width: 10%">Line From</th>
					   <th style="width: 10%">Line To</th>
					   {{if ShowDayOfWeek}}
