...
REM History
REM	-------
REM	2	12/11/2009	MikeVO		Added Abacus COM DLLs.
REM	1	17/11/2008	MikeVO		Initial version.

SET DEST_ROOT=..\..\..\InstallerFiles\AbacusExtranet
...
XCOPY "%SRC_TARGET_WEB%"\AbacusExtranet\bin\RegisterComDlls.bat "%DEST_ROOT%"\AbacusExtranet\bin\
XCOPY "%SRC_TARGET_WEB%"\AbacusExtranet\bin\UnRegisterComDlls.bat "%DEST_ROOT%"\AbacusExtranet\bin\
