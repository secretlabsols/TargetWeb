Ext.define('Actions.Controls.ServiceOrderExceptionsAction', {
    ...
    initComponent: function () {
        ...
        // add the add button
        cfg.approveButton = me.createActionButton(true, 'CreateBatchImage', 'Edit All', 'Edit All Service Order Exceptions?', function () {
