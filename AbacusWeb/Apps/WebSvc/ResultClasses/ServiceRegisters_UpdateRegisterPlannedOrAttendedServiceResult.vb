...
Namespace Apps.WebSvc
    ...
    ''' <summary>
    ''' Class used to represent the result of a call to ServiceRegisters.UpdateRegisterPlannedOrAttendedService
    ''' </summary>
    ''' <history>
    ''' ColinDaly   D12140 07/07/2011 Created
    ''' </history>
    Public Class ServiceRegisters_UpdateRegisterPlannedOrAttendedServiceResult
