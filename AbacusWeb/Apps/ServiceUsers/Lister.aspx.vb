...
Namespace Apps.Dom.SvcUsers

    ''' <summary>
    ''' Web Form used to List Service Users
    ''' </summary>
    ''' <history>
    ''' MoTahir  31/07/2012 D12300 - Created
    ''' </history>
...
#Region "Event Handlers"
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            ' setup the page
            InitPage(WebUtils.ConstantsManager.GetConstant(_WebNavMenuItemKey), "Service Users")

            Dim resultSettings As New ServiceUserSettings()
