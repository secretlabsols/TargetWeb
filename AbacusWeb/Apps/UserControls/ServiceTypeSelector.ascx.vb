...
Namespace Apps.UserControls
    ...
    ''' </history>
    Partial Public Class ServiceTypeSelector
...
#Region "Fields"
        ...
        Private _FilterExcludeServiceCategories As List(Of Integer) = Nothing
        ...
        ' constants
        Private Const _SelectorName As String = "ServiceTypeSelector"
...
#Region "Properties"
        ...
        ''' <summary>
        ''' Gets or sets the service category ids to exclude (except when filtered out by column filters).
        ''' </summary>
        ''' <value>The service category ids to exclude (except when filtered out by column filters).</value>
        Public Property FilterExcludeServiceCategories() As List(Of Integer)
            Get
                Return _FilterExcludeServiceCategories
            End Get
            Set(ByVal value As List(Of Integer))
                _FilterExcludeServiceCategories = value
            End Set
        End Property
...
#Region "Event Handlers"
        ...
        Public Sub InitControl(ByVal thePage As BasePage)
            ...
            js.AppendFormat("{1}_FilterExcludeServiceCategories = {0};", GetListOfIntegerAsJavascriptArrayString(FilterExcludeServiceCategories), _SelectorName)
