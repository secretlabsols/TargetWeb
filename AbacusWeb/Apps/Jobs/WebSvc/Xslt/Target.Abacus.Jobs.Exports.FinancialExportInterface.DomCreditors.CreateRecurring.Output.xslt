...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<!--
		Abacus for Windows Job Service - Dom Creditors Interface - Create Recurring Output.
		
		Formats the Exports.FinancialExportInterface.Dom Creditors.CreateRecurring output information for display.
	-->
