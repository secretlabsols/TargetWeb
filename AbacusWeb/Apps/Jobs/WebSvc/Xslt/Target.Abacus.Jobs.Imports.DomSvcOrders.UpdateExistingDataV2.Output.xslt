...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<!--
		Abacus for Windows Job Service - Dom Svc Orders Import - Update Existing Data V2 Output.
		
		Formats the Imports.DomSvcOrders.UpdateExistingDataV2 output information for display.
	-->
	...
	<xsl:template match="Results">
        ...
        <br />
        <xsl:value-of select="WarningsCount" /> warnings were raised during processing.
        <br /><br />
