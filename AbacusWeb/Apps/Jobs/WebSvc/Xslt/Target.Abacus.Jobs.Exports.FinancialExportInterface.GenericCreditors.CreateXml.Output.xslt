...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<!--
		Abacus for Windows Job Service - Generic Creditors Export - Create Xml Output.
		
		Formats the Exports.FinancialExportInterface.GenericCreditors.CreateXml output information for display.
	-->
