...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<!--
		Abacus for Windows Job Service - Dom Svc Orders Import - Load Interface File V2 Output.
		
		Formats the Imports.DomSvcOrders.LoadInterfaceFileV2 output information for display.
	-->
	<xsl:template match="Results">
		<xsl:value-of select="Count" /> domiciliary service orders were processed from 
		<xsl:choose>
