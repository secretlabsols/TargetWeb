<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="RecalcDomProformaInvoiceStepInputs.ascx.vb" 
Inherits="Target.Abacus.Web.Apps.Jobs.UserControls.RecalcDomProformaInvoiceStepInputs" EnableViewState="true"  %>
...
To submit a job that will recalculate existing pro forma invoices, 
set the required filters below and click the "Create New Job" button.
