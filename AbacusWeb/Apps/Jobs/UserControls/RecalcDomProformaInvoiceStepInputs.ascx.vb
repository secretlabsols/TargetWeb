...
Namespace Apps.Jobs.UserControls
    Partial Public Class RecalcDomProformaInvoiceStepInputs
        ...
        Private Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
            ...
            thePage.JsLinks.Add(WebUtils.GetVirtualPath("AbacusWeb/Apps/Jobs/UserControls/RecalcDomProformaInvoiceStepInputs.js"))
        End Sub
        ...
        Public Function GetCustomInputs(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, _
            ...
            If providerID > 0 Then
                ...
                result.Add(New Triplet(jobStepTypeID, "FilterProviderDesc", String.Format("{0}:{1}", estab.AltReference, estab.Name)))
            End If
