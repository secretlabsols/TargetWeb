<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="InPlaceGenericCreditorSelector.ascx.vb" Inherits="Target.Abacus.Web.Apps.InPlaceSelectors.InPlaceGenericCreditorSelector" %>
