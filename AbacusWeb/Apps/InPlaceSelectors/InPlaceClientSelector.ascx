<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="InPlaceClientSelector.ascx.vb" Inherits="Target.Abacus.Web.Apps.InPlaceSelectors.InPlaceClientSelector" %>
