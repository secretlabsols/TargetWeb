<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="InPlaceClientSubGroupSelector.ascx.vb" Inherits="Target.Abacus.Web.Apps.InPlaceSelectors.InPlaceClientSubGroupSelector" %>
