<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="InPlaceCareManagerSelector.ascx.vb" Inherits="Target.Abacus.Web.Apps.InPlaceSelectors.InPlaceCareManagerSelector" %>
