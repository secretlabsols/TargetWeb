<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Establishments.aspx.vb" Inherits="Target.Abacus.Web.Apps.InPlaceSelectors.Establishments" MasterPageFile="~/Popup.master" %>
<%@ Register TagPrefix="uc1" TagName="EstablishmentSelector" Src="../UserControls/EstablishmentSelector.ascx" %>
