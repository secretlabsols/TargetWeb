<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PrintBatchContract.aspx.vb" Inherits="Target.Abacus.Web.Apps.Dom.ProviderInvoices.PrintBatchContract" MasterPageFile="~/Popup.master" %>
    ...
    <asp:Content ID="Content1" ContentPlaceHolderID="MPContent" runat="server">
	    <div class="header">
	        ...
	        <HeaderTemplate>
			    <table class="listTable" id="tblContracts" style="width:100%;" cellpadding="2" cellspacing="0" summary="List of Contracts.">
				    <tr>
		                <th>Provider Name</th>
		                <th>Contract No.</th>
		                <th>Invoice Count</th>
		    ...
		    <ItemTemplate>
			    <tr>
				    ...
				    <td valign="top"><%#DataBinder.Eval(Container.DataItem, "InvoiceCount")%>&nbsp;</td>
				    <td valign="top"><%#Convert.ToDecimal(DataBinder.Eval(Container.DataItem, "InvoiceValueNet")).ToString("c")%>&nbsp;</td>
				    <td valign="top"><%#Convert.ToDecimal(DataBinder.Eval(Container.DataItem, "InvoiceValueVAT")).ToString("c")%>&nbsp;</td>
				    <td valign="top"><%#Convert.ToDecimal(DataBinder.Eval(Container.DataItem, "InvoiceValueGross")).ToString("c")%>&nbsp;</td>
				</tr>
		    </ItemTemplate>
		    <FooterTemplate>
			    </table>
