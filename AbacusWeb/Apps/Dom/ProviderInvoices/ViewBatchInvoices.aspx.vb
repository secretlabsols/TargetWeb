...
Namespace Apps.Dom.ProviderInvoices
    ...
    Partial Class ViewBatchInvoices
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            ' add page JS
            Me.JsLinks.Add(Target.Library.Web.Utils.GetVirtualPath("AbacusWeb/Apps/Dom/ProviderInvoices/ViewBatchInvoices.js"))
            ...
            js = String.Format("currentPage={0};batchid={1};providerid={2};contractid={3};", _
                 currentPage, batchID, _
                  IIf(providerID Is Nothing Or providerID = "null", "null", String.Format("{0}", providerID)), _
                  IIf(contractID Is Nothing Or contractID = "null", "null", String.Format("{0}", contractID)))
