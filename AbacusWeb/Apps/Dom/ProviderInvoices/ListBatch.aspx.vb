...
Namespace Apps.Dom.ProviderInvoices
    ...
    ''' <summary>
    ''' Screen used to list all domiciliary provider invoice batches.
    ''' </summary>
    ''' <remarks></remarks>
    ''' <history>
    '''     MikeVO      08/07/2009  D11630 - added List and Reports buttons.
    '''                             Removed Summary and Invoices buttons.
    ...
    Partial Class ListBatch
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            ' add page JS
            Me.JsLinks.Add(Target.Library.Web.Utils.GetVirtualPath("AbacusWeb/Apps/Dom/ProviderInvoices/ListBatch.js"))
            ...
            With CType(ctlList, IReportsButton)
                .ButtonText = "List"
                .ReportID = Target.Library.Web.ConstantsManager.GetConstant("AbacusIntranet.WebReport.DomiciliaryProviderInvoiceBatches")
