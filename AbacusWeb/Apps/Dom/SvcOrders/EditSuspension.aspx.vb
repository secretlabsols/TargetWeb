    ...
    Partial Public Class EditSuspension
        ...
        Private Sub PopulateForm(ByVal suspensionID As Integer)
            ...
            If suspensionID > 0 Then
                suspensionHeader = New ServiceOrderSuspensionPeriod(Me.DbConnection)
        ...
        Private Sub DeleteClicked(ByRef e As StdButtonEventArgs)
            ...
            msg = DomContractBL.DeleteDomServiceOrderSuspensionPeriod(Me.DbConnection, suspensionID)
            If msg.Success Then
        ...
        Private Sub SaveClicked(ByRef e As StdButtonEventArgs)
            ...
            suspension = New ServiceOrderSuspensionPeriod(Me.DbConnection)
            If e.ItemID > 0 Then
            ...
            msg = DomContractBL.SaveServiceOrderSuspension(Me.DbConnection, suspension, currentUser.ExternalUsername)
            If Not msg.Success Then
                If msg.Number = DomContractBL.ERR_CAN_NOT_SAVE_SERVICE_ORDER_SUSPENSION Then
        ...
        Private Sub btnSuspend_ServerClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSuspend.ServerClick
            ...
            Dim orderSuspend As DomServiceOrderSuspensionPeriod = New DomServiceOrderSuspensionPeriod(Me.DbConnection)
            Dim msg As ErrorMessage
