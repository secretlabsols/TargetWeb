...
<asp:Content ContentPlaceHolderID="MPPageOverview" runat="server">
	This screen allows you to view, edit or create commissioned service suspensions.
</asp:Content>
		...
		<fieldset id="fsOrders" runat="server">
            ...
            <thead>
                <tr>
                    ...
                    <th style="width:0%;">ServiceOrderID</th>
		    ...
		    <asp:Repeater id="rptSuspensions" runat="server">
		        <ItemTemplate>
		                <tr>
				            ...
				            <td valign="top"><%#DataBinder.Eval(Container.DataItem, "ServiceOrderID")%>&nbsp;</td>
				            ...
				            <td valign="top">
				                <a href="javascript:ViewOrder(<%#DataBinder.Eval(Container.DataItem, "ServiceOrderID")%>);" class="transBg"><%#DataBinder.Eval(Container.DataItem, "OrderReference")%>&nbsp;</a>
				            </td>
