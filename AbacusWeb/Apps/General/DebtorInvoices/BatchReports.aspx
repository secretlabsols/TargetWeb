<%@ Page Language="vb" AutoEventWireup="false" Codebehind="BatchReports.aspx.vb" Inherits="Target.Abacus.Web.Apps.General.DebtorInvoices.BatchReports" %>
...
<%@ Register TagPrefix="uc1" TagName="ReportsButton" Src="~/Library/UserControls/ReportsButton.ascx" %>
	...
	<asp:Content ContentPlaceHolderID="MPPageOverview" runat="server">
		The available reports for the selected debtor invoice batch can be accessed below.
	</asp:Content>
	<asp:Content ContentPlaceHolderID="MPContent" runat="server">
	    ...
	    <br />
	    <label class="label" for="lblInvoiceValueNet">Total Value</label>
        ...
        <fieldset id="fsSelectedReport" class="selectedReport">
            ...
            <!-- batch payments -->
            <div id="divBatchPayments" runat="server" class="availableReport">
                <uc1:ReportsButton id="ctlBatchPayments" runat="server"></uc1:ReportsButton>
            </div>
