...
Namespace Apps.General.DebtorInvoices
    ...
    '''     JohnF       18/05/2009  Created (D11605)
    ''' </history>
    Partial Class ViewBatchReports
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            Me.InitPage(Target.Library.Web.ConstantsManager.GetConstant("AbacusIntranet.WebNavMenuItem.DebtorInvoiceBatchesViewReports"), "Debtor Invoice Batches - View Reports")
            ...
            ' add page JS
            Me.JsLinks.Add(Target.Library.Web.Utils.GetVirtualPath("AbacusWeb/Apps/General/DebtorInvoices/ViewBatchReports.js"))
