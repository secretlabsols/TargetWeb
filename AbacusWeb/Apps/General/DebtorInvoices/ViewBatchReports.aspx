<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ViewBatchReports.aspx.vb" Inherits="Target.Abacus.Web.Apps.General.DebtorInvoices.ViewBatchReports" %>
<%@ Register TagPrefix="ajaxToolkit" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" %>
<%@ Register Assembly="Target.Library.Web" Namespace="Target.Library.Web.Controls" TagPrefix="cc1" %>

	<asp:Content ContentPlaceHolderID="MPPageOverview" runat="server">
		Displayed below are the latest reports produced for the selected Debtor Invoice Batch.
	</asp:Content>
