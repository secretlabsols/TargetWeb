<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VisitCodeGroups.aspx.vb" Inherits="Target.Abacus.Web.Apps.Admin.Dom.VisitCodeGroups" %>
<%@ Register TagPrefix="cc1" Namespace="Target.Library.Web.Controls" Assembly="Target.Library.Web" %>
<%@ Register TagPrefix="uc1" TagName="StdButtons" Src="~/Library/UserControls/StdButtons.ascx" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MPPageOverview" runat="server">
    This screen allows you to maintain the different visit code groups.
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MPContent" runat="server">
    ...
    <fieldset id="fsControls" style="padding:0.5em;" runat="server" EnableViewState="false">
        ...
        <fieldset>
			<legend>Codes</legend>
			<table class="listTable" cellspacing="0" cellpadding="2" summary="List of visit codes in this group." width="100%">
            <caption>List of visit codes in this group</caption>
            <thead>
	            <tr>
		            ...
		            <th valign="top">Standard Time<br />Paid (minutes)</th>
		            <th valign="top">Maximum Time<br />Paid (minutes)</th>
		            <th valign="top">Default<br />Code</th>
		            <th valign="top">&nbsp;</th>
	            </tr>
            </thead>
            <tbody>
				<asp:PlaceHolder ID="phVisitCodes" runat="server"></asp:PlaceHolder>
            </tbody>
			</table>
			<asp:Button id="btnAddVisitCode" runat="server" Text="Add" />
        </fieldset>
    </fieldset>
    <br />
</asp:Content>