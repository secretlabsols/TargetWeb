<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RejectionReasons.aspx.vb" Inherits="Target.Abacus.Web.MovementRequests.RejectionReasons" EnableViewState="false" %>
<%@ Register TagPrefix="cc1" Namespace="Target.Library.Web.Controls" Assembly="Target.Library.Web" %>
<%@ Register TagPrefix="uc1" TagName="StdButtons" Src="~/Library/UserControls/StdButtons.ascx" %>

<asp:Content ID="cpOverview" ContentPlaceHolderID="MPPageOverview" runat="server">

    This screen allows you to maintain rejection reasons for Movement Requests.
