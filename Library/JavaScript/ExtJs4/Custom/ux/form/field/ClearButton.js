    ...
    Ext.define('Target.ux.form.field.ClearButton', {
        ...
        */
        shouldButtonBeVisible: function() {
            if (this.textField.isDisabled() || !this.textField.allowBlank || (this.hideClearButtonReadOnly && this.textField.readOnly) || (this.hideClearButtonWhenEmpty && Ext.isEmpty(this.textField.getValue()))) {
                return false;
            }
