...
Namespace Apps.PIReturns
    ...
    Partial Class PISubmissionStatusEnquiry
        ...
        Private Sub Page_Init(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Init
            ...
            Me.InitPage(ConstantsManager.GetConstant("webSecurityItemPIReturnsListSubmitted"), "PI Submission Status")
            ...
            Dim finYrQtrStep As FinYrQtrFromToPIStatusStep

            ' setup the steps
            provStep = New ProviderStep
            provStep.Required = False
            svcStep = New ServiceStep
            finYrQtrStep = New FinYrQtrFromToPIStatusStep
            ...
            With SelectorWizard1
                ...
                .Steps.Add(New PISubmissionStatusResultsStep)
